...
gcloud projects remove-iam-policy-binding $project --member=serviceAccount:$CONFORMITY_SA_EMAIL 
done
...
gcloud iam service-accounts delete cloud-one-conformity-bot --project=$GCP_PROJECT_ID
